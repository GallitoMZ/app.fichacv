...
@section('content')
    ...
    <div class="content">
        <div class="container-fluid">
            {!! Form::open([
                'route' => ['formulario.datos_generales.guardar'],
                'id' => 'modal_form_guardar',
                'files' => 'true',
            ...
            <div class="card-deck">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md">
                                <div class="form-group">
                                    <input name="file" type="file" id="modal_form_documento_file"
                ...
                <div class="card col-md-9 card-primary card-outline">
                    ...
                    <div class="card-body ">
                        ...
                        <input type="hidden" name="persona_codigo" id="persona_codigo_id"value="{{ $data['persona']->PE_CODIGO }}">
                        <div class="form-row">
                            <div class="form-group col-md">
                                ...
                                {!! Form::text('apellidopater', isset($data['persona']->PE_APELLIDO_P) ? $data['persona']->PE_APELLIDO_P : '', [
                                    'class' => 'form-control form-control-sm input_mayus',
                            ...
                            <div class="form-group col-md">
                                ...
                                {!! Form::text('apellidomater', isset($data['persona']->PE_APELLIDO_M) ? $data['persona']->PE_APELLIDO_M : '', [
                                    'class' => 'form-control form-control-sm input_mayus',
                            ...
                            <div class="form-group col-md">
                                ...
                                {!! Form::text('nombre', isset($data['persona']->PE_NOMBRES) ? $data['persona']->PE_NOMBRES : '', [
                                    'class' => 'form-control form-control-sm input_mayus',
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md">
                                <div class="input-group-sm">
                                    ...
                                    {!! Form::select(
                                        'paisNacimiento',
                                        $data['paises_eleccion'],
                                        isset($data['persona']->PE_PAIS_NACION) ? $data['persona']->PE_PAIS_NACION : '',
                                        ['class' => 'form-control select2', 'required', 'style' => 'width:100%', 'id' => 'nacionalidad_id'],
                                    ) !!}
                                </div>
                            </div>
                            <div class="form-group col-md">
                                ...
                                {!! Form::text('ciudad', isset($data['persona']->PE_CIUD_NACION) ? $data['persona']->PE_CIUD_NACION : '', [
                                    'class' => 'form-control form-control-sm input_mayus',
                                    'placeholder' => 'Ciudad ',
                                    'required',
                                    'id' => 'ciudad_id',
                            ...
                            <div class="form-group col-md">
                                ...
                                <div class="input-group">
                                    {!! Form::text('fec_naci', isset($data['persona']->PE_FECHA_NAC) ? $data['persona']->getFechaNacimiento() : '', [
                                        'class' => 'form-control form-control-sm daterangepick',
                                        'id' => 'fec_naci_id',
                                    ]) !!}
                            ...
                            <div class="form-group col-md">
                                <div class="input-group-sm">
                                    ...
                                    {!! Form::select(
                                        'paisDocumento',
                                        $data['paises_eleccion'],
                                        isset($data['persona']->PE_PAIS_DOCU) ? $data['persona']->PE_PAIS_DOCU : '',
                                        ['class' => 'form-control select2', 'required', 'style' => 'width:100%', 'id' => 'pais_docu_id'],
                                    ) !!}
                                </div>
                            </div>
                            <div class="form-group col-md">
                                <div class="input-group-sm">
                                    ...
                                    {!! Form::select(
                                        'tipodocumento',
                                        $data['tiposdocumento'],
                                        isset($data['persona']->PE_TIPO_DOCU) ? $data['persona']->PE_TIPO_DOCU : '',
                                        ['class' => 'form-control select2', 'required', 'style' => 'width:100%', 'id' => 'tipo_docu_id'],
                                    ) !!}
                                </div>
                            </div>
                            <div class="form-group col-md">
                                ...
                                {!! Form::text('numdocumento', isset($data['persona']->PE_NUM_DOCU) ? $data['persona']->PE_NUM_DOCU : '', [
                        ...
                        <div class="form-row">
                            <div class="form-group col-md">
                                ...
                                {!! Form::text(
                                    'email',
                                    isset($data['persona']->PE_CORREO) ? $data['persona']->PE_CORREO : $data['user']->email,
                                    [
                                        'class' => 'form-control form-control-sm',
                                        'placeholder' => 'Numero de Documento',
                                        'disabled',
                            ...
                            <div class="form-group col-md">
                                <div class="input-group-sm">
                                    ...
                                    {!! Form::select('sexo', $data['sexo'], isset($data['persona']->PE_SEXO) ? $data['persona']->PE_SEXO : '', [
                            ...
                            <div class="form-group col-md">
                                <div class="input-group-sm">
                                    ...
                                    {!! Form::select(
                                        ...
                                        isset($data['persona']->PE_ESTADO_CIV) ? $data['persona']->PE_ESTADO_CIV : '',
                                        ['class' => 'form-control select2', 'required', 'style' => 'width:100%', 'id' => 'estado_civil_id'],
                                    ) !!}
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md">
                                ...
                                {!! Form::text('celular', isset($data['persona']->PE_NUM_CEL) ? $data['persona']->PE_NUM_CEL : '', [
                                    'class' => 'form-control form-control-sm',
                            ...
                            <div class="form-group col-md">
                                <div class="input-group-sm">
                                    ...
                                    {!! Form::text('linkedin', isset($data['persona']->PE_LINKEDIN) ? $data['persona']->PE_LINKEDIN : '', [
                                        'class' => 'form-control form-control-sm',
                                        'placeholder' => 'Pagina de Linkedin',
                                        'id' => 'linkedin_id',
                                    ]) !!}
                        ...
                        <div class="form-row">
                            <div class="form-group col-md">
                                ...
                                {!! Form::textarea('perfil', isset($data['persona']->PE_PERFIL) ? $data['persona']->PE_PERFIL : '', [
                                    'class' => 'form-control form-control-sm',
                                    'placeholder' => 'Ingrese descripción de su perfil profesional',
                                    'id' => 'perfil_id',
                                    'rows' => '3',
                                ]) !!}
                            </div>
